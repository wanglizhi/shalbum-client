...
import edu.nju.shalbum.util.AppClient;
import edu.nju.shalbum.util.HttpUtil;
import android.content.Context;
/**
 * 自定义的基础任务线程池，通过ExecutorService实现，定义了三种addTask方法
 * @author wlz
 *
 */
public class BaseTaskPool {
	
	// task thread pool 任务线程池
