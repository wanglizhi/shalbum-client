...
public class ShareCardFragment extends BaseFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.doTaskAsync(C.task.getHotAlbums, C.api.getHotAlbums, albumParams);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mPullRefreshScrollView.setOnRefreshListener(new OnRefreshListener2<ScrollView>(){
			...
			public void onPullDownToRefresh(
				...
				HashMap<String, String> albumParams = new HashMap<String, String>();
				albumParams.put("pageid", 0+"");
				doTaskAsync(C.task.getHotAlbums, C.api.getHotAlbums, albumParams);
				isRefresh = true;
			}
